# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-12 02:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(choices=[(1, '货到付款'), (1, '微信支付'), (1, '支付宝'), (1, '银联支付')], default=1, verbose_name='支付方式')),
                ('status', models.SmallIntegerField(choices=[(1, '待支付'), (1, '待收货'), (1, '已完成'), (1, '代发货'), (1, '待评价')], default=1, verbose_name='订单状态')),
